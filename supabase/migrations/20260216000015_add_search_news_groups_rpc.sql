-- 뉴스 그룹 검색 RPC 함수 (pg_trgm similarity 기반)
...
-- 코멘트
comment on function search_news_groups is '뉴스 그룹 검색 (pg_trgm similarity 기반, representative_article + articles JSONB 포함)';
